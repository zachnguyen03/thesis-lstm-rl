...
weights_file = './Weights/weight_lstm2-okko.hdf5'
...
#            )
            ...
            future_rewards = ff_model_target.predict(tf.convert_to_tensor(np.reshape(lstm_output_sample,(batch_size, num_lstm_units))))
